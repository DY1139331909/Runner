...
public class CaseData {
    ...
    public void initCaseDataInput(String caseDataInputStr, String caseName) {
        ...
        while (iterComp.hasNext()) {
            ...
            caseDataInput.put(entry.getKey().toString(),paraMap);
        }
...
//    }
    ...
    public static void main(String[] args) {
        ...
        caseData.initCaseDataInput(a,"市价买入-深-正例-主板-0c-数量1000-00001");
        System.out.println(caseData.getCaseDataInput("账户信息查询","case_acct"));
    }
